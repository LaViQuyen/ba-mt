...
export const cam19_test4 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://dl.dropboxusercontent.com/scl/fi/v801admq2iaa4pi899d6p/mt8.mp3?rlkey=juo811dwfpe7ii94mkhht41t2", // Bạn nhớ kiểm tra file âm thanh
      timeLimit: 1733, // 30 phút
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 8 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1: Questions 1-6 (Notes Completion) ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; margin-bottom: 20px;">
                <h3 style="margin-top:0; color:#2B6830; text-align:center;">First day at work</h3>
        ...
        // --- PART 1: Questions 7-10 (Table Completion) ---
        {
          ...
          "htmlContent": `
            <div style="background:#fff; padding:15px; border:1px solid #ddd; margin-bottom: 20px;">
                <h3 style="margin-top:0; color:#2B6830; text-align:center;">Responsibilities</h3>
        ...
        // --- PART 4: Questions 31-40 ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; line-height:1.8;">
              <h3 style="text-align:center; color:#2B6830;">Tree planting</h3>
