...
export const mqr_test1 = {
    ...
    sections: {
        ...
        // ==========================================================================
        listening: {
            audioSrc: "https://firebasestorage.googleapis.com/v0/b/beablevn-ielts.firebasestorage.app/o/audio%2Fmqr1.mp3?alt=media&token=b0a1e2de-57d0-4f5b-b64d-33e5a2ab33eb", // Vui lòng cung cấp file audio thích hợp
            timeLimit: 1911,
            ...
            questions: [
                ...
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Beach Skippers<br>Junior Member Application Form</h3>
                ...
                <table style="width:100%; border-collapse: collapse; min-width: 600px;">
                    <tbody>
                        ...
                        <tr>
                            <td colspan="4" style="padding:10px; border-bottom:1px solid #ccc; font-weight:bold; color:#2B6830; background:#e9ecef;">Parent/guardian details</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" style="padding:10px; border-bottom:1px solid #ccc; font-weight:bold; color:#2B6830; background:#e9ecef;">Child/children Details</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" style="padding:10px; border-bottom:1px solid #ccc; font-weight:bold; color:#2B6830; background:#e9ecef;">Swimming and sports background</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4" style="padding:10px; border-bottom:1px solid #ccc; font-weight:bold; color:#2B6830; background:#e9ecef;">Other information</td>
                        </tr>
                        <tr>
          ...
          `,
            ...
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-bottom: 30px; width: 100%; clear: both;">
                <h4 style="color:#2B6830; margin-bottom: 15px; text-align: center;">Grace's Creek Activity Camp</h4>
          ...
          `,
            ...
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Synthetic Spider Silk</h3>
              
              <h4 style="color:#2B6830;">Commercial issues</h4>
              ...
              <h4 style="color:#2B6830; margin-top: 20px;">Properties and applications of spider silk</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.8;">
      ...
      `,
          ...
          `,
            ...
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Navigating the locks</h3>
