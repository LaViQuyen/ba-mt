...
export const sm6_test28 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://firebasestorage.googleapis.com/v0/b/beablevn-ielts.firebasestorage.app/o/audio%2Fmt31.mp3?alt=media&token=dfa31808-4e58-43c0-9b51-61016b92f072", // Thay bằng đường dẫn file audio thực tế
      timeLimit: 1703, // 30 phút
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 28 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; border-radius: 8px; margin-bottom: 20px;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Cycling Course Booking Form</h3>
        ...
        // --- PART 2 ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; border-radius: 8px; margin-bottom: 20px;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Green Gate Shopping Centre<br>Information Help Sheet</h3>
                
                <h4 style="color:#2B6830; border-bottom: 1px solid #ccc; padding-bottom: 5px;">Access</h4>
                ...
                <h4 style="color:#2B6830; border-bottom: 1px solid #ccc; padding-bottom: 5px;">Opening Times</h4>
                <ul style="line-height: 1.8;">
                ...
                <h4 style="color:#2B6830; border-bottom: 1px solid #ccc; padding-bottom: 5px;">Saturday Grand Opening</h4>
                <ul style="line-height: 1.8;">
        ...
        },
        {
          ...
          htmlContent: `
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-bottom: 30px; width: 100%; clear: both;">
                <h4 style="color:#2B6830; margin-bottom: 15px; text-align: center;">Green Gate Shopping Centre</h4>
        ...
        // --- PART 3 ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd; margin-bottom: 20px; line-height: 1.8;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Karen and Denis' Study Year in Australia</h3>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Myers-Briggs Personality Type Indicator</h3>
    ...
    reading: {
      ...
      questions: [
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Great Man Theory and Trait Theory</h3>
