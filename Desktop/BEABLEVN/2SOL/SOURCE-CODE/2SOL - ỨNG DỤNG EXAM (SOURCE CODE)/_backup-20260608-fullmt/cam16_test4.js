...
export const cam16_test4 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://firebasestorage.googleapis.com/v0/b/beablevn-ielts.firebasestorage.app/o/audio%2Fmt20.MP3?alt=media&token=b9652e75-5ed7-470e-837a-c6b37cd1b093", // Đảm bảo có file mp3 này
      timeLimit: 1760,
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 20 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Holiday rental</h3>
                
                <p><strong>Owners' names:</strong> Jack Fitzgerald and Shirley Fitzgerald</p>
                
                <h4 style="color:#2B6830; margin-bottom: 10px;">Granary Cottage</h4>
                ...
                <h4 style="color:#2B6830; margin-bottom: 10px;"><span class="q-badge-inline">3</span><input class="gap-input" data-qnum="3"> Cottage</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#2B6830; margin-bottom: 10px;">Payment</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                    <li>deposit: £144</li>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">THE EXTINCTION OF THE DODO BIRD</h3>
              <p>The dodo was a large flightless bird which used to inhabit the island of Mauritius.</p>
              
              <h4 style="color:#2B6830;">History</h4>
              ...
              <h4 style="color:#2B6830;">Description</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.6;">
              ...
              <h4 style="color:#2B6830;">Reasons for extinction</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.6;">
        ...
        // --- PASSAGE 1 QUESTIONS (Diagram Labelling) ---
        {
          ...
          htmlContent: `
            <div style="background:#fff; padding:15px; border:1px solid #ccc; text-align: center; border-radius: 8px;">
                <h4 style="color:#2B6830;">The Persian Qanat Method</h4>
        ...
        // --- PASSAGE 2 QUESTIONS (Summary Dropdown) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#2B6830;">Studies on digital screen use</h4>
