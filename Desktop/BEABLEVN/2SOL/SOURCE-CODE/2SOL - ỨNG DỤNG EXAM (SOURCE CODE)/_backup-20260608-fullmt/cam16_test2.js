...
export const cam16_test2 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://firebasestorage.googleapis.com/v0/b/beablevn-ielts.firebasestorage.app/o/audio%2Fmt18.mp3?alt=media&token=4cc0ca8c-ca9c-4da8-818b-11e89dc03eea",
      timeLimit: 1769,
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 18 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Copying photos to digital format</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ccc; max-width: 600px; margin: 0 auto; text-align: center; font-family: 'Segoe UI', sans-serif;">
                <h4 style="color:#2B6830; margin-top:0;">Assignment plan</h4>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Health benefits of dance</h3>
    ...
    reading: {
      ...
      questions: [
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">The Uffington White Horse</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#2B6830;">We should be more tolerant of microbes</h4>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#2B6830;">The characteristics of wise reasoning</h4>
