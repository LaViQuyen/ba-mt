...
export const sm6_test27 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://firebasestorage.googleapis.com/v0/b/beablevn-ielts.firebasestorage.app/o/audio%2Fmt30.mp3?alt=media&token=d84d6b5a-eb46-40c9-a85e-1acf03f3dd36", // Cần bổ sung file audio tương ứng
      timeLimit: 1769, // 30 phút
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 27 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "mcq_single",
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; border-radius: 8px; overflow-x: auto;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">The Sydney Trip</h3>
        ...
        },
        {
          ...
          htmlContent: `
             <div style="display: flex; flex-direction: column; align-items: center; margin-bottom: 30px; width: 100%;">
                <h4 style="color:#2B6830; margin-bottom: 15px;">Diagram of a Spreading Crack</h4>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">What is Addiction?</h3>
              ...
              <h4 style="color:#2B6830; margin-top:20px;">Treatment for Drug and Alcohol Addictions</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.8;">
              ...
              <h4 style="color:#2B6830; margin-top:20px;">Treatment for Behavioural Addictions (based on cognitive-behavioural principles)</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.8;">
    ...
    reading: {
      ...
      questions: [
        ...
        },
        {
          ...
          htmlContent: `
            <div style="display: flex; flex-direction: column; align-items: center; margin-bottom: 30px; width: 100%;">
                <h4 style="color:#2B6830; margin-bottom: 15px;">Refraction with a Convex Lens</h4>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Telescopes: 18th - 21st Centuries</h3>
              
              <h4 style="color:#2B6830; margin-top:20px;">18th Century</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.8;">
              ...
              <h4 style="color:#2B6830; margin-top:20px;">19th Century</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.8;">
              ...
              <h4 style="color:#2B6830; margin-top:20px;">20th + 21st Centuries</h4>
              <ul style="list-style-type: disc; margin-left: 20px; line-height: 1.8;">
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Producing Olive Oil</h3>
