...
export const cam17_test3 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://dl.dropboxusercontent.com/scl/fi/wepg8obrti7n8xgacafdp/mt15.mp3?rlkey=9ug6sf9dgmb1089g8k6p5z5uq",
      timeLimit: 1760,
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 15 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1: Questions 1-10 ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Advice on surfing holidays</h3>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Bird Migration Theory</h3>
        ...
        // --- PASSAGE 1 QUESTIONS (Notes) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">The thylacine</h3>
        ...
        // --- PASSAGE 3 QUESTIONS (Summary with Box) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#2B6830;">The bedrock myth</h4>
