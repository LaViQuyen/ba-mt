        ...
        // --- PART 1: Questions 1-6 (Notes) ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; margin-bottom: 20px;">
                <h3 style="margin-top:0; color:#002554; text-align:center;">Local food shops</h3>
        ...
        // --- PART 3: Questions 26-30 (Flowchart HTML with Select) ---
        {
          ...
          "htmlContent": `
            <div style="background:#fff; padding:20px; border:1px solid #ccc; max-width: 800px; margin: 0 auto;">
                <div style="border: 2px solid #002554; padding: 15px; margin-bottom: 30px; background: #fdfdfd; display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 10px;">
        ...
        // --- PART 4: Questions 31-40 (Notes) ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd;">
                <h3 style="text-align:center; margin-top:0; color:#002554;">Microplastics</h3>
