...
export const cam17_test1 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "/audio/mt13.mp3", // Bạn cần file mp3 này
      timeLimit: 1689, 
      passage: "<h3 style='text-align:center; color:#002554;'>MOCK TEST 13 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">Buckworth Conservation Group</h3>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Labyrinths</h3>
    ...
    reading: {
      ...
      questions: [
        // --- PASSAGE 1 QUESTIONS (Notes) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">The London underground railway</h3>
        ...
        // --- PASSAGE 2 QUESTIONS (Summary) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#002554;">Roman amphitheatres</h4>
        ...
        // --- PASSAGE 3 QUESTIONS (Summary with Box) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#002554;">The story behind the hunt for Charles II</h4>
