...
export const cam16_test1 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://dl.dropboxusercontent.com/scl/fi/e9o8ky7en4sypaw90h5zp/mt17.mp3?rlkey=tz81o03cvmcge0zm1iaf4ezob",
      timeLimit: 1606,
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 17 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Children's Engineering Workshops</h3>
                
                <h4 style="color:#2B6830; margin-bottom: 10px;">Tiny Engineers (ages 4-5)</h4>
                ...
                <h4 style="color:#2B6830; margin-bottom: 10px;">Junior Engineers (ages 6-8)</h4>
                <p><strong>Activities</strong></p>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#2B6830; margin-bottom: 10px;">Location</h4>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Stoicism</h3>
              ...
              <h4 style="color:#2B6830;">Ancient Stoics</h4>
              ...
              <h4 style="color:#2B6830;">Stoic principles</h4>
              <ul style="list-style-type: disc; margin-left: 20px;">
              ...
              <h4 style="color:#2B6830;">The influence of Stoicism</h4>
              <ul style="list-style-type: disc; margin-left: 20px;">
              ...
              <h4 style="color:#2B6830;">Relevance of Stoicism</h4>
              <ul style="list-style-type: disc; margin-left: 20px;">
        ...
        // --- PASSAGE 1 QUESTIONS (Table) ---
        {
          ...
          htmlContent: `
            <div style="background:#fff; padding:15px; border:1px solid #ccc;">
                <h3 style="text-align: center; color: #2B6830;">Reasons why polar bears should be protected</h3>
        ...
        // --- PASSAGE 2 QUESTIONS (Notes) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">The Step Pyramid of Djoser</h3>
...
cam16_test1.sections.reading.questions.push(
    {
      ...
      htmlContent: `
        <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
          <h4 style="text-align:center; color:#2B6830;">The 'algorithmication' of jobs</h4>
