        ...
        // --- PART 1: Questions 1-10 ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">JUNIOR CYCLE CAMP</h3>
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Instructors</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Classes</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">What to bring</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Day 1</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Cost</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Hand knitting</h3>
    ...
    reading: {
      ...
      questions: [
        ...
        // --- PASSAGE 1 QUESTIONS (Summary) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Warships and merchant ships</h3>
        ...
        // --- PASSAGE 2 QUESTIONS (Summary) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Interesting finds at an archaeological site</h3>
