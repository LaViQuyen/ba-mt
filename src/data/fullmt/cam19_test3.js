...
export const cam19_test3 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://dl.dropboxusercontent.com/scl/fi/b5huvr91rcyj2d5yhxh8v/mt7.mp3?rlkey=g2za8j7awx1s83xv4v4k3z848",
      timeLimit: 1591,
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 7 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1: Questions 1-6 ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; margin-bottom: 20px;">
                ...
                <ul>
                    <li>Kite Place - near the <span class="q-badge-inline">1</span><input type="text" class="gap-input" data-qnum="1" id="q-1"></li>
                    <li>Fish market:
                        <ul>
                            <li>cross the <span class="q-badge-inline">2</span><input type="text" class="gap-input" data-qnum="2" id="q-2"> and turn right</li>
                            <li>best to go before <span class="q-badge-inline">3</span><input type="text" class="gap-input" data-qnum="3" id="q-3"> pm, earlier than closing time</li>
                        </ul>
                    </li>
                    <li>Organic shop:
                        <ul>
                            <li>called <span class="q-badge-inline">4</span><input type="text" class="gap-input" data-qnum="4" id="q-4"></li>
                            <li>below a restaurant in the large, grey building</li>
                            <li>look for the large <span class="q-badge-inline">5</span><input type="text" class="gap-input" data-qnum="5" id="q-5"> outside</li>
                        </ul>
                    </li>
                    <li>Supermarket:
                        <ul>
                            <li>take a <span class="q-badge-inline">6</span><input type="text" class="gap-input" data-qnum="6" id="q-6"> minibus, number 289</li>
                        </ul>
                    </li>
                </ul>
            </div>
        ...
        // --- PART 1: Questions 7-10 (Tách riêng bảng Shopping) ---
        {
          "type": "gap",
                ...
                <table style="width:100%; border-collapse: collapse;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="padding:10px; border:1px solid #ccc;">a handful of <span class="q-badge-inline">7</span><input type="text" class="gap-input" data-qnum="7" id="q-7"> (type of seaweed)</td>
                        </tr>
                        <tr>
                            <td style="padding:10px; border:1px solid #ccc; font-weight:bold;">Organic shop</td>
                            <td style="padding:10px; border:1px solid #ccc;">beans and a <span class="q-badge-inline">8</span><input type="text" class="gap-input" data-qnum="8" id="q-8"> for dessert</td>
                            <td style="padding:10px; border:1px solid #ccc;">spices and <span class="q-badge-inline">9</span><input type="text" class="gap-input" data-qnum="9" id="q-9"></td>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:10px; border:1px solid #ccc;">a <span class="q-badge-inline">10</span><input type="text" class="gap-input" data-qnum="10" id="q-10"> tart</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        // --- PART 3: Questions 26-30 (Flowchart HTML) ---
        {
          "type": "gap",
          ...
          "htmlContent": `
            <div style="background:#fff; padding:20px; border:1px solid #ccc; max-width: 800px; margin: 0 auto;">
                <div style="border: 2px solid #333; padding: 15px; margin-bottom: 30px; background: #fdfdfd;">
                    <strong>A</strong> size &nbsp;&nbsp;&nbsp; 
                    <strong>B</strong> escape &nbsp;&nbsp;&nbsp; 
                    <strong>C</strong> age &nbsp;&nbsp;&nbsp; 
                    <strong>D</strong> water<br><br>
                    <strong>E</strong> cereal &nbsp;&nbsp;&nbsp; 
                    <strong>F</strong> calculations &nbsp;&nbsp;&nbsp; 
                    <strong>G</strong> changes &nbsp;&nbsp;&nbsp; 
                    <strong>H</strong> colour
                </div>

                <div style="border:1px solid #000; padding:15px; text-align:left; background: #fff;">
                ...
                <div style="border:1px solid #000; padding:15px; text-align:left; background: #fff;">
                    <p style="margin:5px 0;">Put each group in a separate cage.</p>
        ...
        // --- PART 4: Questions 31-40 ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd;">
                ...
                <ul>
                    <li>fibres from some <span class="q-badge-inline">31</span><input type="text" class="gap-input" data-qnum="31" id="q-31"> during washing</li>
                ...
                <ul>
                    <li>They cause injuries to the <span class="q-badge-inline">32</span><input type="text" class="gap-input" data-qnum="32" id="q-32"> of wildlife and affect their digestive systems.</li>
                    <li>They enter the food chain, e.g., in bottled and tap water, <span class="q-badge-inline">33</span><input type="text" class="gap-input" data-qnum="33" id="q-33"> and seafood.</li>
                    <li>They may not affect human health, but they are already banned in skin cleaning products and <span class="q-badge-inline">34</span><input type="text" class="gap-input" data-qnum="34" id="q-34"> in some countries.</li>
                    <li>Microplastics enter the soil through the air, rain and <span class="q-badge-inline">35</span><input type="text" class="gap-input" data-qnum="35" id="q-35">.</li>
                </ul>

                <p><strong>Microplastics in the soil - a study by Anglia Ruskin University</strong></p>
                <ul>
                    <li>Earthworms are important because they add <span class="q-badge-inline">36</span><input type="text" class="gap-input" data-qnum="36" id="q-36"> to the soil.</li>
                    <li>The study aimed to find whether microplastics in earthworms affect the <span class="q-badge-inline">37</span><input type="text" class="gap-input" data-qnum="37" id="q-37"> of plants.</li>
                    <li>The study found that microplastics caused:
                        <ul>
                            <li><span class="q-badge-inline">38</span><input type="text" class="gap-input" data-qnum="38" id="q-38"> loss in earthworms</li>
                            <li>fewer seeds to germinate</li>
                            <li>a rise in the level of <span class="q-badge-inline">39</span><input type="text" class="gap-input" data-qnum="39" id="q-39"> in the soil.</li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>changes to soil damage both ecosystems and <span class="q-badge-inline">40</span><input type="text" class="gap-input" data-qnum="40" id="q-40">.</li>
                </ul>
            </div>
          `,
          "items": [
    ...
    // ==========================================================================
    // PHẦN READING (Đã cập nhật bài đọc đầy đủ)
    // ==========================================================================
    reading: {
      passage: `
        <div style="margin-bottom: 50px;">
            ...
            <h3 style="text-align: center; font-size: 1.5rem; color: #333;">Archaeologists discover evidence of prehistoric island settlers</h3>
        ...
        },
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd;">
                ...
                <p>Excavations of rock shelters inside <span class="q-badge-inline">8</span><input type="text" class="gap-input" data-qnum="8" id="q-8"> near the village of Kelo revealed:</p>
                <ul>
                    <li>axes from around 14,000 years ago, probably used to make canoes</li>
                    <li>axes made out of <span class="q-badge-inline">9</span><input type="text" class="gap-input" data-qnum="9" id="q-9"> dating from around 11,700 years ago</li>
                    <li><span class="q-badge-inline">10</span><input type="text" class="gap-input" data-qnum="10" id="q-10"> of an animal: evidence of what ancient islanders ate</li>
                    <li>evidence of travel between islands:
                        <ul>
                            <li>obsidian: a material that is not found naturally on Obi</li>
                            <li><span class="q-badge-inline">11</span><input type="text" class="gap-input" data-qnum="11" id="q-11"> which resembled ones found on other islands.</li>
                        </ul>
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>had <span class="q-badge-inline">12</span><input type="text" class="gap-input" data-qnum="12" id="q-12"> as well as items made out of metal</li>
                    <li>probably took part in the production and sale of <span class="q-badge-inline">13</span><input type="text" class="gap-input" data-qnum="13" id="q-13"></li>
                </ul>
            </div>
          `,
          "items": [
    ...
    // ==========================================================================
    // PHẦN WRITING (Trang 75 - 76)
    // ==========================================================================
    writing: {
      task1: {
        title: "Writing Task 1",
        instruction: "You should spend about 20 minutes on this task.",
        // ⚠️ Cắt ảnh biểu đồ từ trang 75 của PDF và thay link vào đây
        image: "https://i.postimg.cc/0QMyP0yL/Screenshot-2026-01-11-111557.png", 
