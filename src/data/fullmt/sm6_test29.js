...
export const sm6_test29 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://dl.dropboxusercontent.com/scl/fi/ltr6k1dwema0kj8oa3ifr/mt32.mp3?rlkey=yhof32tzw6kn0afn380bpq9jj", // Thay bằng đường dẫn file audio thực tế
      timeLimit: 1621, // 30 phút
      passage: "<h3 style='text-align:center; color:#2B6830;'>MOCK TEST 29 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; border-radius: 8px; margin-bottom: 20px;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Jarvis Removal Services</h3>
        ...
        // --- PART 2 ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd; margin-bottom: 20px;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">The Life of Michael Hallam</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#fff; padding:20px; border-radius:8px; border: 1px solid #ddd; overflow-x: auto;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Law Course Details</h3>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Icelandic Sheep Farming</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-bottom: 30px; width: 100%; clear: both;">
                <h4 style="color:#2B6830; margin-bottom: 15px; text-align: center;">Icelandic Sheep Farm Temporary Fence</h4>
    ...
    reading: {
      ...
      questions: [
        ...
        // --- PASSAGE 2 QUESTIONS ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
              <h3 style="text-align:center; color:#2B6830; margin-top:0;">Dyscalculia</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
                <h3 style="text-align:center; color:#2B6830; margin-top:0;">Objections to Product Placement</h3>
                
                <h4 style="color:#2B6830; margin-top:20px;">General Objections</h4>
                ...
                <h4 style="color:#2B6830; margin-top:20px;">Specific Objections</h4>
