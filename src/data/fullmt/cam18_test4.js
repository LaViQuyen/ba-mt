...
export const cam18_test4 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "https://firebasestorage.googleapis.com/v0/b/beablevn-ielts.firebasestorage.app/o/audio%2Fmt12.mp3?alt=media&token=687b547a-d4d1-4ee8-b9fd-483ef9c6f4f7", // Bạn cần đảm bảo có file này trong thư mục public
      timeLimit: 1756,
      passage: "<h3 style='text-align:center; color:#002554;'>MOCK TEST 12 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">Job details from employment agency</h3>
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Work involves:</h4>
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Requirements:</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
                ...
                <h4 style="color:#002554; margin-bottom: 10px;">Other information:</h4>
                <ul style="list-style-type: disc; padding-left: 25px; line-height: 1.8;">
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Victor Hugo</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#002554;">Making buildings with wood</h4>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="font-family: 'Segoe UI', sans-serif; line-height: 1.8; background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#002554;">Wegener’s life and work</h4>
