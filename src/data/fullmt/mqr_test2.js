    ...
    sections: {
        ...
        listening: {
            ...
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border: 1px solid #ddd; margin-bottom: 20px;">
                <h3 style="text-align:center; color:#002554; margin-top:0; margin-bottom: 20px;">Notes on Bytecycle</h3>
          ...
          htmlContent: `
            ...
            <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; margin-bottom: 30px; width: 100%; clear: both;">
                <h4 style="color:#002554; margin-bottom: 15px; text-align: center; font-size: 1.3rem;">Cranbrook Community Centre</h4>
          ...
          items: [
            ...
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Low-cost housing for homeless people</h3>
              
              <h4 style="color:#002554;">Shipping containers already used in London</h4>
