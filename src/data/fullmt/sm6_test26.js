        ...
        },
        {
          ...
          htmlContent: `
            <div style="display: flex; flex-direction: column; align-items: center; margin-bottom: 30px; width: 100%;">
                <h4 style="color:#002554; margin-bottom: 15px;">Mrs. Smith's Flat</h4>
        ...
        },
        {
          ...
          htmlContent: `
             <div style="text-align: center; margin-bottom: 20px;">
                <h4 style="color:#002554; margin-bottom: 15px;">A Trout Farm</h4>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif; line-height: 1.8;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">The Lord Howe Stick Insect</h3>
        ...
        // --- PASSAGE 1 QUESTIONS ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Social Intelligence</h3>
