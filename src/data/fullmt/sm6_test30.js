...
export const sm6_test30 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "/audio/mt33.mp3", // Cần bổ sung file audio tương ứng
      timeLimit: 1684,
      passage: "<h3 style='text-align:center; color:#002554;'>MOCK TEST 30 - LISTENING SECTION</h3>",
      questions: [
        // --- PART 1 ---
        {
          type: "gap",
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border: 1px solid #ddd;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">West Water Meeting</h3>
        ...
        // --- PART 4 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">The Great White Shark</h3>
    ...
    reading: {
      ...
      questions: [
        // --- PASSAGE 1 QUESTIONS ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">Growing Oysters</h3>
        ...
        },
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">Criticisms of Hypnosis</h3>
