        ...
        // --- PART 1: Questions 1-10 ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; margin-bottom: 20px;">
                <h3 style="margin-top:0; color:#002554; text-align:center;">Transport survey</h3>
        ...
        // --- PART 4: Questions 31-40 ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
                <h3 style="text-align:center; color:#002554;">Elephant translocation</h3>
      ...
      questions: [
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Urban farming in Paris</h3>
        ...
        },
        {
          ...
          "htmlContent": `
            <div style="background:#fff; padding:20px; border:1px solid #ddd; overflow-x:auto;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">Intensive farming versus aeroponic urban farming</h3>
