        ...
        // --- PART 1: Questions 1-10 ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; border-radius: 8px; font-family: 'Segoe UI', sans-serif;">
                <h3 style="text-align:center; color:#002554; margin-top:0;">Opportunities for voluntary work in Southoe village</h3>
                ...
                <br>
                <h4 style="color:#002554; margin-bottom: 10px;">Village social events</h4>
                <table style="width:100%; border-collapse: collapse; margin-top: 10px; background: #fff;">
                    <tr style="background: #002554; color: #fff;">
        ...
        // --- PART 4: Questions 31-40 ---
        {
          ...
          htmlContent: `
            <div style="background:#f0f4f8; padding:25px; border:1px solid #ccc; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">The impact of digital technology on the Icelandic language</h3>
        ...
        // --- PASSAGE 1 QUESTIONS (Notes) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:25px; border:1px solid #ddd; font-family: 'Segoe UI', sans-serif;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">The Dead Sea Scrolls</h3>
        ...
        // --- PASSAGE 3 QUESTIONS (Summary with Box) ---
        {
          ...
          htmlContent: `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h4 style="text-align:center; color:#002554;">The origins of creative behaviour</h4>
