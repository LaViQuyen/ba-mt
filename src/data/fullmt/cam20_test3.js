...
export const cam20_test3 = {
  ...
  sections: {
    ...
    // ==========================================================================
    listening: {
      audioSrc: "/audio/mt3.mp3", // ⚠️ Hãy thay đổi đường dẫn file MP3 thật của bạn ở đây
      timeLimit: 1882,
      passage: "<h3 style='text-align:center; color:#002554;'>MOCK TEST 3 - LISTENING SECTION</h3>",
      questions: [
