        ...
        // --- PART 1: Questions 1-5 (Notes - Giao diện mới) ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border:1px solid #ddd; margin-bottom: 20px;">
                <h3 style="margin-top:0; color:#002554; text-align:center;">Working at Milo's Restaurants</h3>
                
                <h4 style="border-bottom:1px solid #ccc; color:#002554;">Benefits</h4>
                ...
                <h4 style="border-bottom:1px solid #ccc; margin-top: 15px; color:#002554;">Person specification</h4>
                <ul style="list-style-type: disc; padding-left: 20px; line-height: 1.8;">
          ...
          "htmlContent": `
            <div style="background:#fff; padding:15px; border:1px solid #ccc;">
                <table style="width:100%; border-collapse: collapse; font-size: 0.95rem;">
                    <thead style="background:#002554; color:white;">
                        <tr>
        ...
        // --- PART 4: Questions 31-40 (Giao diện mới) ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px; border:1px solid #ddd;">
                <h3 style="text-align:center; color:#002554;">Pockets</h3>
    ...
    reading: {
      ...
      questions: [
        // --- PASSAGE 1 QUESTIONS (Giao diện mới) ---
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h3 style="text-align:center; color:#002554; margin-top:0;">Stonehenge</h3>
              ...
              <ul>
                ...
                <li>theories about the transportation of the bluestones:
                  <ul>
                    <li>archaeological: builders used <span class="q-badge-inline">3</span><input type="text" class="gap-input" data-qnum="3" id="input-3"> to make sledges and rollers OR pulled them on giant baskets</li>
                    ...
                    <li>geological: they were brought from Wales by <span class="q-badge-inline">5</span><input type="text" class="gap-input" data-qnum="5" id="input-5"></li>
                  </ul>
                </li>
              </ul>
        ...
        // --- PASSAGE 2 QUESTIONS ---
        {
          ...
          "items": [
            { "qNum": 14, "text": "What point does the writer make about AI in the first paragraph?", "options": ["A. It is difficult to predict how quickly AI will progress.", "B. Much can be learned about the use of AI in chess machines.", "C. The future is unlikely to see limitations on the capabilities of AI.", "D. Experts disagree on which specialised tasks AI will be able to perform."], "answer": "B" },
            ...
            { "qNum": 16, "text": "Why does the writer mention the story of King Midas?", "options": ["A. to compare different visions of progress", "B. to illustrate that poorly defined objectives can go wrong", "C. to emphasise the need for cooperation", "D. to point out the financial advantages of a course of action"], "answer": "C" },
            { "qNum": 17, "text": "What challenge does the writer refer to in the fourth paragraph?", "options": ["A. encouraging humans to behave in a more principled way", "B. deciding which values we want AI to share with us", "C. creating a better world for all creatures on the planet", "D. ensuring AI is more human-friendly than we are ourselves"], "answer": "E" },
        ...
        },
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:8px;">
              <h3 style="text-align:center; color:#002554;">Using AI in the UK health system</h3>
        ...
        },
        {
          ...
          "htmlContent": `
            <div style="background:#f9f9f9; padding:20px; border-radius:5px;">
              <h3 style="text-align:center; color:#002554;">Leonardo da Vinci's ideal city</h3>
