...
export default function ReviewHubPage() {
  ...
  const handlePreview = (item, isMock) => {
    if (isMock) {
        ...
        navigate(`/writing-practice/${item.id}`);
    }
  };
  ...
  if (loading) {
    return (
      <div style={{ width: '100%', padding: '100px 20px', textAlign: 'center', color: '#002554' }}>
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '40px auto', padding: '0 20px', minHeight: 'calc(100vh - 200px)' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h1 style={{ color: '#002554', margin: '0 0 10px 0', fontSize: '2.2rem' }}>
